...
이를 바탕으로 고민하던 중 대학교 때 들었던 웹디자인 수업이 생각났다. 웹디자인을 하고 코드를 작성해서 웹에 그려진다는 것을 처음 깨달았던 수업이었다. 실습했을 때 굉장히 재밌었던 기억이고, 내가 원하던 일과 일치하는 부분이 있다고 생각되었고, 집에 돌아와 바로 관련 코드 작성하는 영상과 자료를 찾아보고 흥미는 확신이 되었다. 확신이 들었으니, 행동으로 옮겼고 그렇게 퍼블리싱 공부를 하게 되었다. 6개월 교육 과정을 들으면서 정말 즐거웠다. 20대 후반에 듣는 교육이라 금전적 여유가 없어 야간 알바를 병행했다. 잠이 부족했음에도 잠을 자는 것보다 코드 한 줄이라도 더 작성하고 싶었고, UI를 하나라도 더 개발하고 싶었고, 해결하지 못한 코드가 있다면 꿈에서라도 고민해서 해결해 냈다(진짜 꿈을 통해 해결한 건 아니지만, 자꾸 작업하는 꿈을 꿨다). 정말 깔끔한 코드를 작성할 줄 아는 사람이 되고 싶어서 노력했고, 그런 시간과 노력을 통해 KBS미디어에 입사하게 되었다.
<br/>
<br/>
